...
const Channel = props => (
  ...
  <div id="sidebar" className="dragscroll">
    <ul className="sidebar-menu">
      ...
      <li><a href="/dashboard" className="current-server" data-toggle="tooltip" data-placement="right" data-title="channel name"><img src="http://forreadingaddicts.co.uk/wp-content/uploads/2016/10/stranger-things-icon.jpg" alt=""></img></a></li>
