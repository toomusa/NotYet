...
const Channel = props => (
  ...
  <div id="sidebar" className="dragscroll">
    <ul className="sidebar-menu">
      <li className="toggle-sidebar"><a href="/dashboard" className="sidebar-toggle" data-toggle="sidebar"><img src="https://cdn1.iconfinder.com/data/icons/ninja-things-1/1772/ninja-simple-512.png" alt=""></img></a></li>
      ...
      <li><a href="/chatarea" className="current-server" data-toggle="tooltip" data-placement="right" data-title="channel name"><img src="http://forreadingaddicts.co.uk/wp-content/uploads/2016/10/stranger-things-icon.jpg" alt=""></img></a></li>
      ...
      <li><a href="/" className="join-server createChannel" data-start="modal-custom" data-target="#create-group" data-toggle="tooltip" data-placement="right" data-title="Join a Group"><img src="http://icons.iconarchive.com/icons/gakuseisean/ivista-2/128/Alarm-Plus-icon.png" alt=""></img></a></li>
    </ul>
  </div>
);
