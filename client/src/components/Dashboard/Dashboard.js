                            ...
                            <div className="col-md-6">
                                ...
                                <div className="groups-list scroll-hijack">
                                    <ul className="list">
                                        ...
                                        <li><a href="/"><div className="avatar"><img className="little_avatar" src="https://cdn1.iconfinder.com/data/icons/ninja-things-1/1772/ninja-simple-512.png" alt="" /></div>Stranger Things&nbsp;  S.1 &nbsp; E.8    &nbsp;&nbsp;       Rating: 5</a></li>
